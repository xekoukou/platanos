...
char key[20];  //key+st_piece makes the hash ,key is the routing_address or the subscription subject that we will accept from this node.
...
int router_init(router_t **router);
